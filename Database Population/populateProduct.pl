...
while($line = <input>) {
	...
	$printline = "INSERT INTO batch VALUES($temp[3],'2013-10-05',$stock1,NULL);\n";
	print batch $printline;
	$printline = "INSERT INTO batch VALUES($temp[3],'2013-10-15',$stock2,NULL);\n";
	print batch $printline;
	if($temp[7] != 0){
		$printline = "INSERT INTO promotion VALUES($temp[3],$i,$type,$temp[7],NULL);\n";
		$i++;
