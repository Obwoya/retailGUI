...
# Form implementation generated from reading ui file 'UiFiles\UpdateUnit.ui'
#
# Created: Sat Dec 07 18:34:48 2013
...
class Ui_UpdatePDUMap(object):
    def setupUi(self, UpdatePDUMap):
        ...
        self.gridLayout.addWidget(self.error_Bar, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_bar, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.device_barcode, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.error_Port, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.device_port, 1, 1, 1, 1)
        self.label_port = QtGui.QLabel(self.gridLayoutWidget_2)
        self.label_port.setStyleSheet(_fromUtf8(""))
    ...
    def retranslateUi(self, UpdatePDUMap):
        ...
        self.label_port.setText(_translate("UpdatePDUMap", "Port", None))
